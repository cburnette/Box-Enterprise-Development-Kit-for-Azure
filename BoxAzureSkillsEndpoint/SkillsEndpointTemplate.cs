...
namespace Box.EnterpriseDevelopmentKit.Azure
{
    ...
    public static class SkillsEndpointTemplate
    {
        ...
        private static JObject BuildTranscriptCardFromFakeData()
        {
            ...
            var entryTwo = new TranscriptCardEntry("Goodby Cruel World!", new List<EntryAppearance>() { appearanceTwo });
        ...
        private static JObject BuildKeywordCarFromFakeData()
        {
            ...
            var entryOne = new KeywordCardEntry("work platform", new List<EntryAppearance>() { appearanceOne, appearanceTwo });
        ...
        private static JObject BuildTimelineCardFromFakeData()
        {
            ...
            var entryOne = new TimelineCardEntry("Unknown #1", imageUrl, new List<EntryAppearance>() { appearanceOne, appearanceTwo });
