...
namespace Box.EnterpriseDevelopmentKit.Azure
{
    ...
    public static class SkillsEndpointTemplate
    {
        ...
        {
            var appearanceOne = new SkillsCardEntryAppearance(9.95, 14.8);
            var entryOne = new TranscriptCardEntry("Hello World!", new List<SkillsCardEntryAppearance>() { appearanceOne });

            var appearanceTwo = new SkillsCardEntryAppearance(14.8, 17.5);
            var entryTwo = new TranscriptCardEntry("Goodbye World!", new List<SkillsCardEntryAppearance>() { appearanceTwo });
        ...
        {
            var appearanceOne = new SkillsCardEntryAppearance(9.95, 0);
            var appearanceTwo = new SkillsCardEntryAppearance(14.8, 0);
            var entryOne = new KeywordCardEntry("work platform", new List<SkillsCardEntryAppearance>() { appearanceOne, appearanceTwo });

            var entries = new List<KeywordCardEntry>() { entryOne };
